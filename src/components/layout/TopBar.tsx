...
import { Badge, Button, Card, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Badge className="h-8 rounded-md border border-border/80 bg-card px-2.5" style={TOP_BAR_NO_DRAG_STYLE}>
            <img
